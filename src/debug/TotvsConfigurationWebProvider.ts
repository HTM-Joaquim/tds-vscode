...
export class TotvsConfigurationWebProvider
  ...
  resolveDebugConfiguration(
    ...
    const connectedServerItem: IServerDebugger = serverManager.currentServer;
    ...
    if (connectedServerItem !== undefined) {
      ...
      config.buildVersion = connectedServerItem.build;

      config.environment = connectedServerItem.environment;
      config.serverName = connectedServerItem.name;
